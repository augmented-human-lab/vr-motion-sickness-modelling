...
def clean(df_sess_path):
    ...
    df_final=df_cleaned2[['frame', 'timestamp', 'MS_rating',  'IndTrig_L', 'IndTrig_R', 'HandTrig_L', 'HandTrig_R', 'Thumb_L_x', 
'Thumb_R_x', 'Thumb_L_y', 'Thumb_R_y', 'le_roll', 'le_pitch', 'le_yaw', 'LE_speed', 'h_roll', 'h_pitch', 'h_yaw', 'Head_Speed', 'Head_Velocity_Change', 'Head_AngVel_Change', 'c_roll', 'c_pitch', 'c_yaw',  'c_speed', 'c_velocity1', 'c_acceleration1','c_velocity2', 'c_acceleration2', 'c_velocity3', 'c_acceleration3', 'text_presence', 'change in brightness', 'diff_HE_yaw', 'diff_HE_roll', 'diff_HE_pitch']]
